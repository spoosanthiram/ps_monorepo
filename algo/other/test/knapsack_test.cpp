...
{
    auto retval = ps::algo::read_knapsack_items("algo/other/test/data/knapsack.txt");
    REQUIRE(ps::algo::knapsack(retval.second, retval.first) == 2'493'893);
}

TEST_CASE("AlgoClass Knapsack Big")
{
    auto retval = ps::algo::read_knapsack_items("algo/other/test/data/knapsack_big.txt");
